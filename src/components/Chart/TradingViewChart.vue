    ...
    <div>
        <v-form v-model="valid">
            <v-container>
                <v-row>
                    <v-col cols="8" md="4">
                        <v-autocomplete label="Stock Symbles" density="compact"
                            :items="['California', 'Colorado', 'Florida', 'Georgia', 'Texas', 'Wyoming']"></v-autocomplete>
                    </v-col>

                    <v-col cols="8" md="2">
                        <v-select density="compact" label="Time Frame" :items="['1H', '1D']"></v-select>
                    </v-col>

                    <v-col cols="8" md="2">
                        <v-select density="compact" label="Type Of Chart" :items="['Line Chart', 'Candlestick Chart']"></v-select>
                    </v-col>
